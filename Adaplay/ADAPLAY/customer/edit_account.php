...
$customer_country = $row_customer['cliente_país'];
 
$customer_city = $row_customer['customer_city'];
 
$customer_contact = $row_customer['cliente_contact'];
 
$customer_address = $row_customer['cliente_address'];
...
if (isset($_POST['update'])) {
    ...
    $update_customer = "update clientes set cliente_nome='$c_name',cliente_email='$c_email',cliente_país='$c_country',customer_city='$c_city',customer_contact='$c_contact',customer_address='$c_address',customer_image='$c_image' where cliente_id='$update_id'";
    ...
    if ($run_customer) {
        ...
        echo "<script>alert('Sua conta foi atualizada, faça login novamente')</script>";
