...
// Obtém informações do cliente com base no endereço de email da sessão.
            ...
            $get_wishlist = "select * from lista_de_desejos where cliente_id='$customer_id'";
            ...
            while ($row_wishlist = mysqli_fetch_array($run_wishlist)) {
                ...
                $wishlist_id = $row_wishlist['Lista_de_Desejos_id'];
 
                $product_id = $row_wishlist['produto_id'];
 
                $get_products = "select * from produtos where produto_id='$product_id'";
                ...
                $product_url = $row_products['produto_url'];
 
                $product_img1 = $row_products['produto_img1'];
