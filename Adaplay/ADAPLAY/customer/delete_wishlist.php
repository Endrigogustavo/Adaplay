...
// Cria uma consulta SQL para excluir o item da lista de desejos com base no seu ID.
    $delete_wishlist = "delete from lista_de_desejos where Lista_de_Desejos_id='$delete_id'";
 
    // Executa a consulta no banco de dados.
    $run_delete = mysqli_query($con, $delete_wishlist);
  // Verifica se a exclusão foi bem-sucedida.
    if ($run_delete) {
// Exibe um alerta de sucesso informando que o item da lista de desejos foi excluído.
