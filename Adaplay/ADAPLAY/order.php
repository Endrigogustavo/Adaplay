...
$select_cart = "select * from carrinho where ip_add='$ip_add'"; // Consulta o carrinho do usuário com base no endereço IP.
...
while ($row_cart = mysqli_fetch_array($run_cart)) {
    ...
    $delete_cart = "delete from carrinho where ip_add='$ip_add'";
