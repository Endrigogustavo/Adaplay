                    ...
                    <div class="table-responsive"><!-- table-responsive Starts -->
                        ...
                        <table class="table table-bordered table-hover table-striped"><!-- table table-bordered table-hover table-striped Starts -->
                            ...
                            <tbody><!-- tbody Starts -->
                                ...
                                $get_order = "select * from pendente_orders order by 1 DESC LIMIT 0,5";
                                $run_order = mysqli_query($con, $get_order);
 
                                while ($row_order = mysqli_fetch_array($run_order)) {
 
 
                                    $order_id = $row_order['ordem_id'];
 
                                    $c_id = $row_order['cliente_id'];
 
                                    $invoice_no = $row_order['fatura_no'];
 
                                    $product_id = $row_order['produto_id'];
 
                                    $qty = $row_order['qty'];
 
                                    $size = $row_order['size'];
 
                                    $order_status = $row_order['ordem_status'];
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            $get_customer = "select * from clientes where cliente_id='$c_id'";
